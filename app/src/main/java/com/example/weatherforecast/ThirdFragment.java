...
public class ThirdFragment extends Fragment {
        ...
        AsyncTask.execute(new Runnable() {
            ...
            public void run() {
                ...
                if (sampleApiCalls.size() == 0)
                    ...
                    //so sanh
                    if (!mIdApiCall.getListItem().get(16).getDtTxt().substring(0, 4).equals(today.year + ""))
                        check = true;
                    else if (!mIdApiCall.getListItem().get(16).getDtTxt().substring(5, 7).equals((today.month + 1) + ""))
                        check = true;
                    else if (!mIdApiCall.getListItem().get(16).getDtTxt().substring(8, 10).equals(today.monthDay < 10 ? ("0" + today.monthDay) : (today.monthDay + "")))
                        check = true;
    ...
    private void onCreateHeadFragment() {
        ...
        binding.statusTextView.setText(mIdApiCall.getListItem().get(16).getWeather().get(0).getDescription());
        double nhietdo = mIdApiCall.getListItem().get(16).getMain().getTemp() - 273.15;
        binding.temperatureTextView.setText((int) nhietdo + "");
        double nhietdoMax = mIdApiCall.getListItem().get(16).getMain().getTempMax() - 273.15;
        binding.temperatureUpTextView.setText((int) nhietdoMax + "");
        double nhietdoMin = mIdApiCall.getListItem().get(16).getMain().getTempMin() - 273.15;
        binding.temperatureDownTextView.setText((int) nhietdoMin + "");
        switch (mIdApiCall.getListItem().get(16).getWeather().get(0).getMain()) {
            case "Snow": {
