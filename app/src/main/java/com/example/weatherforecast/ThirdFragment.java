...
public class ThirdFragment extends Fragment {
    ...
    private void onCreateHeadFragment() {Date dt = new Date(System.currentTimeMillis());
        ...
        binding.statusTextView.setText(mIdApiCall.getListItem().get(16).getWeather().get(0).getDescription().toUpperCase());
